...
Available Data
Danny has shared the data design for Foodie-Fi and short descriptions on each of the database tables - our case study focuses on only 2 tables but there will be challenging to create a new table for the Foodie-Fi team.

 

Table 1: plans
Customers can choose which plans to join Foodie-Fi when they first sign up.
Basic plan customers have limited access and can only stream their videos and are only available monthly at $9.90
...
SELECT
  DATE_PART('month',start_date) AS month_date, -- Cast month as integer
  TO_CHAR(start_date, 'MMMM') AS month_name, -- Cast month as string
